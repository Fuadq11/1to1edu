                    		...
                    		<tr>
                    			<td>
                                    ...
                                    <?php if(isset($selQuestRow['exans_answer'])){
                    						...
                    						{ ?>
                    							<span style="color:red"><?php echo "Your Answer: ".$selQuestRow[answer($selQuestRow['question_type'],$selQuestRow['exans_answer'])]." <br> -Wrong<br> <strong>Answer is: ".$selQuestRow[answer($selQuestRow['question_type'],$selQuestRow['exam_answer'])]."</strong>"; ?></span>
                    						<?PHP }
                    						else
                    						{ ?>
                    							<span class="text-success"><?php echo "Your Answer: ".$selQuestRow[answer($selQuestRow['question_type'],$selQuestRow['exans_answer'])]." <br>  -Correct<br> <strong>Answer is: ".$selQuestRow[answer($selQuestRow['question_type'],$selQuestRow['exam_answer'])]."</strong>"; ?></span>
                    						<?php } }else{ ?>

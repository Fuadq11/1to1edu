...
if (!empty($_GET['s_id'])) {
    ...
    $selSessions = $conn->prepare("SELECT * FROM sessions WHERE session_id = ?");
    $selSessions->execute([$session_id]);
...
<div class="container my-4">
        <div class="mb-4">
            ...
            <h4 class="mt-3">Student: <span class="text-dark"><?= $selExamin['exmne_fullname'] ?></span></h4>
        </div>
